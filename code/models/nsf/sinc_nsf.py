#!/usr/bin/env python
"""
_model.py for harmonic-plus-noise NSF with trainable sinc filter
...
class Model(torch_nn.Module):
    ...
    def __init__(self, in_dim, out_dim, args, mean_std=None):
        ...
        self.upsamp_rate = 512 #prj_conf.input_reso[0]
        # sampling rate (Hz)
        self.sampling_rate = args.sr #prj_conf.wav_samp_rate
